...
<main>
    ...
    <section class="right-slant-shape bg-primary pb-10 pt-4" data-cue="fadeIn">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2 col-md-12 position-relaive" data-cue="zoomIn">
        ...
        <div class="position-absolute z-1 w-100 text-center top-25 mt-n8" data-cue="zoomIn">
            <img src="<?= esc_url(get_stylesheet_directory_uri()); ?>/img/profile/yg-pp2.jpeg" alt="avatar" width="216"
                ...
                <div class="col-lg-7 offset-lg-1 col-12">
                    <div class="row">
                        ...
                        <div class="col-md-6 mt-md-5">
                            ...
                            <div class="card bg-success bg-opacity-10 border-0 mb-5 mb-lg-0" data-cue="fadeIn"
                                data-delay="1500">
                                <div class="card-body">
                                    <div class="mb-4">
            ...
            <div class="row mb-lg-9 mb-5">
                <div class="col-xl-10 offset-xl-1 col-md-12">
                    ...
                    <div class="row" data-cue="zoomIn">
                        ...
                        <div class="col-md-6 col-12">
                            <p class="mb-0">I love building for the web. From something as simple as a single HTML file
            ...
            <!-- <div class="row">
                <div class="col-lg-4 col-md-12 col-12" data-cue="zoomIn">
                    <div class="mb-5 mb-lg-0 text-center text-lg-start px-md-5">
                        ...
                        <p class="mb-0">Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Fusce
                            dapibus, tellus ac cursus. Aenean eu leo quam.</p>
                    </div>
                </div>
                <div class="col-lg-8">
                    <div class="row">
                        <div class="col-md-6 col-12" data-cue="fadeIn">
                            <div class="mb-lg-8 mb-5 text-center text-lg-start px-3 px-lg-0">
                                ...
                                <p class="mb-0 pe-lg-4">We craft a plan aligned with your business objectives, submit a
                                    comprehensive proposal.</p>
                            </div>
                        </div>
                        <div class="col-md-6 col-12" data-cue="fadeIn">
                            <div class="mb-lg-8 mb-5 text-center text-lg-start px-3 px-lg-0">
                                ...
                                <p class="mb-0">We design the Idea in Figma and seek approval. We offer 2 free design
                                    iterations.</p>
                            </div>
                        </div>
                        <div class="col-md-6 col-12" data-cue="fadeIn">
                            <div class="mb-lg-8 mb-5 text-center text-lg-start px-3 px-lg-0">
                                ...
                                <p class="mb-0 pe-lg-4">Agile Development: Sprints, Milestones, and weekly Progress
                                    Tracking.</p>
                            </div>
                        </div>
                        <div class="col-md-6 col-12" data-cue="fadeIn">
                            <div class="mb-lg-8 mb-5 text-center text-lg-start px-3 px-lg-0">
                                ...
                                <p class="mb-0 pe-lg-4">Complete Project Delivery with Complimentary One Month
                                    Maintenance.</p>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card-body p-5">
                                    ...
                                    <form class="needs-validation" novalidate>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="email" class="form-control" id="yourEmailInput"
                                                placeholder="Email" required="" />
                                            <div class="invalid-feedback">Please enter email.</div>
                                        </div>
                                        <div class="mb-3">
                                            <label for="messageTextarea" class="form-label">Describe your
                                                project</label>
                                            <textarea class="form-control" id="messageTextarea"
                                                placeholder="Write the information about your project." rows="4"
                                                required></textarea>
                            ...
                            <div class="d-flex mb-4">
                                ...
                                <div class="ms-2">
                                    ...
                                    <small>
                                        ...
                                        <span class="ms-lg-3"><a href="#!"
                                                class="text-reset">helloteam@example.com</a></span>
                                    </small>
                                </div>
                            </div>
                            <div>
