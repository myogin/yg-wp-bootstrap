...
<footer class="pt-7">
        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-6 col-md-6">
                <div class="mb-7 text-center">
                    <div class="mb-3">
                        <img src="<?= esc_url(get_stylesheet_directory_uri()); ?>/img/profile/yg-profile.jpg"
                            alt="avatar" class="avatar avatar-xl rounded-circle" />
                    </div>

                    <h3 class="mb-0">Yogi Nugraha</h3>
                    <small>FullStack Developer at Legacy FA</small>
                </div>

                <div class="text-center ">
                    <a href="https://www.linkedin.com/in/myogin/" class="text-reset btn btn-linkedin btn-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <a href="https://www.instagram.com/madeyoginugraha/" class="text-reset btn btn-instagram btn-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
    ...
    <div class="bootscore-info bg-body-tertiary text-body-tertiary py-2 copyright">
        <div class="<?= bootscore_container_class(); ?>">
            <?php if (is_active_sidebar('footer-info')) : ?>
            <?php dynamic_sidebar('footer-info'); ?>
            <?php endif; ?>
            <span class="bootscore-copyright  "><span class="cr-symbol">&copy;</span>&nbsp;<?= date('Y'); ?>
                <span class="text-primary"><a href="#">YG Creative Studio</a></span>
                | Designed by
                <span class="text-primary"><a href="#">Yogi Nugraha</a></span></span>
